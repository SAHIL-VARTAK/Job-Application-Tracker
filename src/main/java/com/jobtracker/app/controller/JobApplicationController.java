...
public class JobApplicationController {
  ...
  @Operation(
      ...
      description =
          "Returns all job applications whose company name contains the provided keyword.")
  @GetMapping("/search")
  ...
  @PostMapping
  public JobApplication createApplication(@Valid @RequestBody CreateJobApplicationRequest request) {
    return service.addApplication(request.company(), request.role(), request.notes());
  }
  ...
  public void updateStatus(@PathVariable int id, @Valid @RequestBody UpdateStatusRequest request) {
