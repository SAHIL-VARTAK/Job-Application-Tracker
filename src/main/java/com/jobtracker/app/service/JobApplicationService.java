...
public class JobApplicationService {
  ...
  public JobApplication addApplication(String company, String role, String notes) {
    JobApplication application =
        new JobApplication(null, company, role, ApplicationStatus.APPLIED, LocalDate.now(), notes);
