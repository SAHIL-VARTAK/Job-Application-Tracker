...
class JobApplicationRepositoryTest {
    ...
    @Test
    @DisplayName(
            "Should save and retrieve a job application"
    )
    ...
    @Test
    @DisplayName(
            "Should find applications by company name ignoring case"
    )
    void shouldFindByCompanyContainingIgnoreCase() {
        ...
        List<JobApplication> applications =
                repository.findByCompanyContainingIgnoreCase(
                        "goo"
                );
    ...
    @Test
    @DisplayName(
            "Should return applications ordered by applied date descending"
    )
    void shouldReturnApplicationsOrderedByDate() {
        ...
        assertEquals(
                "Google",
                applications.getLast().getCompany()
        );
    }
}